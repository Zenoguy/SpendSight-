  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-3 glass rounded-2xl soft-shadow hover:glow-purple transition-all duration-300"
      >
        ...
        <div className="h-full flex flex-col p-6 custom-scrollbar overflow-y-auto">
              ...
              <div className="relative p-4 glass rounded-2xl soft-shadow hover:soft-shadow-lg transition-all duration-300 border border-white/20">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-3">
                    ...
                    {!isCollapsed && (
                      <div>
                        <span className="font-semibold text-white">{tierInfo[selectedTier].name}</span>
                        <div className="text-sm text-gray-300">{tierInfo[selectedTier].price}</div>
                      </div>
                    )}
                  </div>
                </div>
          ...
          <div className="mt-auto">
            ...
            >
              ...
              {!isCollapsed && (
                <span className="text-gray-300 group-hover:text-white transition-colors">Sign Out</span>
              )}
            </button>
          </div>
